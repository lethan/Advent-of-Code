defmodule AoC.Year2020.Day12 do
  def import(file) do
  ...
  def task1(input) do
    {east, north, _orientation_east, _orientation_north} =
      input
  ...
  def task2(input) do
    {east, north, _waypoint_east, _waypoint_north} =
      input
...
# input = AoC.Year2020.Day12.import("input/2020/input_day12.txt")

# input
# |> AoC.Year2020.Day12.task1()
# |> IO.puts()

# input
# |> AoC.Year2020.Day12.task2()
# |> IO.puts()
